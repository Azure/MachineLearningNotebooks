...
parser.add_argument('--output_dir', type=str, help='output model directory')
...
if hvd.rank() == 0:
    callbacks.append(keras.callbacks.ModelCheckpoint(output_dir + '/checkpoint-{epoch}.h5'))
